<?php
/**
 * Documents & Uploads tab: intro, status summary, and the Save form (Visa Documents, Bank Payment Proof,
 * scope note). See CHADA_TRAVEL_Admin_Settings::render_documents_uploads_tab().
 *
 ...
 * @var string $chada_travel_visa_documents_html Pre-escaped.
 * @var string $chada_travel_bank_proof_html Pre-escaped.
 * @var string $chada_travel_scope_note_html Pre-escaped.
 */
...
assert(isset($chada_travel_visa_documents_html));
assert(isset($chada_travel_bank_proof_html));
assert(isset($chada_travel_scope_note_html));
?>
...
<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- pre-escaped by the caller, see the _html naming convention documented in CHADA_TRAVEL_Template. ?>
<?php echo $chada_travel_visa_documents_html; ?>
<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- pre-escaped by the caller, see the _html naming convention documented in CHADA_TRAVEL_Template. ?>
<?php echo $chada_travel_bank_proof_html; ?>
<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- pre-escaped by the caller, see the _html naming convention documented in CHADA_TRAVEL_Template. ?>
<?php echo $chada_travel_scope_note_html; ?>

<p class="submit"><button type="submit" class="button button-primary">
<?php esc_html_e('Save Documents & Uploads Settings', 'chada-travel'); ?>
</button></p>
</form>
