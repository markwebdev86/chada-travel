<?php
/**
 * See CHADA_TRAVEL_Admin_Bookings::build_table_row_html().
 *
 ...
 * @var string $chada_travel_updated_note Raw; escaped here (already-translated "Updated <date>" text).
 */
...
assert(isset($chada_travel_updated_note));
?>
<tr>
...
<td data-label="<?php echo esc_attr__('Total', 'chada-travel'); ?>">
<strong><?php echo esc_html($chada_travel_total_formatted); ?></strong>
<div class="chada-travel-muted chada-travel-small"><?php echo esc_html($chada_travel_updated_note); ?></div>
</td>
<td data-label="<?php echo esc_attr__('Action', 'chada-travel'); ?>">
<a class="button button-small" href="<?php echo esc_url($chada_travel_view_url); ?>"><?php esc_html_e('Open', 'chada-travel'); ?></a>
</td>
</tr>
