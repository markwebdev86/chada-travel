<?php
/**
 * One dismissible admin notice. See CHADA_TRAVEL_Admin_Booking_Detail::render_notices().
 *
...
echo esc_attr($chada_travel_type); ?> is-dismissible"><p><?php echo esc_html($chada_travel_message); ?></p></div>
