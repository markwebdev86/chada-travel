<?php
/** Front-end Featured Tours image-top card grid. */
...
<div class="chada-travel-featured-tours__card-body">
<h3 class="chada-travel-featured-tours__name"><?php echo esc_html($chada_travel_card['name']); ?></h3>
<div class="chada-travel-featured-tours__meta">
<span class="chada-travel-featured-tours__meta-item">
<?php
echo '<svg class="chada-travel-featured-tours__icon" viewBox="0 0 24 24" aria-hidden="true" focusable="false">'
...
<div class="chada-travel-featured-tours__action">
<?php /* translators: %s: Tour name. */ ?>
<?php $chada_travel_view_detail_label = sprintf(__('View detail about %s', 'chada-travel'), $chada_travel_card['name']); ?>
<?php
printf(
    '<a class="chada-travel-featured-tours__button" href="%s" aria-label="%s">%s</a>',
    esc_url($chada_travel_card['permalink']),
    esc_attr($chada_travel_view_detail_label),
    esc_html(__('VIEW DETAILS', 'chada-travel'))
);
?>
</div>
</div>
