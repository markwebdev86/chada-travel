<?php
/**
 * Deterministic installer-country to default-currency mapping.
 *
 * Generated from Unicode CLDR 48 supplementalData.xml currencyData for 2026-07-21. When CLDR lists multiple
 * concurrently tender currencies, the first CLDR entry is the initial operational default; the owner can
 * always change Currency in General Settings. This mapping is not an exchange-rate, tax, or legal-tender API.
 *
...
final class CHADA_TRAVEL_Country_Currency_Map {
    public const SOURCE_VERSION = 'Unicode CLDR 48';
    public const SNAPSHOT_DATE = '2026-07-21';
    ...
    private const CURRENCIES = [
        ...
        'CY' => 'EUR', 'CZ' => 'CZK', 'DE' => 'EUR', 'DG' => 'USD', 'DJ' => 'DJF', 'DK' => 'DKK',
        'DM' => 'XCD', 'DO' => 'DOP', 'DZ' => 'DZD', 'EA' => 'EUR', 'EC' => 'USD', 'EE' => 'EUR',
        'EG' => 'EGP', 'EH' => 'MAD', 'ER' => 'ERN', 'ES' => 'EUR', 'ET' => 'ETB', 'EU' => 'EUR',
        ...
        'GY' => 'GYD', 'HK' => 'HKD', 'HM' => 'AUD', 'HN' => 'HNL', 'HR' => 'EUR', 'HT' => 'HTG',
        'HU' => 'HUF', 'IC' => 'EUR', 'ID' => 'IDR', 'IE' => 'EUR', 'IL' => 'ILS', 'IM' => 'GBP',
        ...
        'LI' => 'CHF', 'LK' => 'LKR', 'LR' => 'LRD', 'LS' => 'ZAR', 'LT' => 'EUR', 'LU' => 'EUR',
        ...
        'SR' => 'SRD', 'SS' => 'SSP', 'ST' => 'STN', 'SV' => 'USD', 'SX' => 'XCG', 'SY' => 'SYP',
        'SZ' => 'SZL', 'TA' => 'GBP', 'TC' => 'USD', 'TD' => 'XAF', 'TF' => 'EUR', 'TG' => 'XOF',
    ...
    /** Returns the CLDR default currency for one uppercase two-letter territory code. */
    public static function get_currency(string $chada_travel_country_code): ?string {
        return self::CURRENCIES[strtoupper($chada_travel_country_code)] ?? null;
    }
